                    ...
                    <td>
                        <select name="category">
                            ...
                            <?php 
                                ...
                                $sql = "SELECT * FROM category_master WHERE active='Yes'";
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "item-Name-".rand(0000,9999).".".$ext; //New Image Name May Be "item-Name-657.jpg"
                ...
                $sql2 = "INSERT INTO item_master SET 
                    title = '$title',
